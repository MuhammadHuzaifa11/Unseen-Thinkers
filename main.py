...
if uploaded_file:
    ...
    if st.session_state["summary"] and st.session_state["anomalies"] and st.session_state["actions"]:
        ...
        report_text = f"""UNSEEN THINKERS STRATEGIC REPORT
====================================
METRICS:
- Total Sales: {vital_stats['financials']['sales']}
- Net Profit: {vital_stats['financials']['profit']}
- Profit Margin: {vital_stats['financials']['margin']}
...
{st.session_state['actions']}
====================================
Generated by Unseen Thinkers AI
"""
